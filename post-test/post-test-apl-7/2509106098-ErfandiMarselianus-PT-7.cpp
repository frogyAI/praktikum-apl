...
void validasiJenis(const char jenis[]) {
    if (strcmp(jenis, "Karnivora") != 0 && 
        strcmp(jenis, "Herbivora") != 0 && 
        strcmp(jenis, "Omnivora") != 0) {
        throw invalid_argument("Error: Jenis binatang harus Karnivora, Herbivora, atau Omnivora!");
    }
}

void validasiHabitat(const char habitat[]) {
    if (strcmp(habitat, "Darat") != 0 && 
        strcmp(habitat, "Air") != 0 && 
        strcmp(habitat, "Udara") != 0) {
        throw invalid_argument("Error: Habitat harus Darat, Air, atau Udara!");
    }
}

void validasiUmur(int umur) {
    if (umur < 0) {
        throw runtime_error("Error: Umur tidak boleh negatif!");
    }
    if (umur > 200) {
        throw runtime_error("Error: Umur terlalu besar! Maksimal 200 tahun.");
    }
}

void validasiNama(const char nama[]) {
    if (strlen(nama) == 0) {
        throw length_error("Error: Nama binatang tidak boleh kosong!");
    }
}
...
void cariBerdasarkanKode(Binatang *arr, int *n, int targetKode) {
    if (targetKode <= 0) {
        throw invalid_argument("Error: Kode binatang harus bernilai positif!");
    }
    
    if (*n == 0) {
        throw runtime_error("Error: Belum ada data binatang untuk dicari!");
    }
...
void cariBerdasarkanNama(Binatang *arr, int *n, char keyword[]) {
    ...
    if (strlen(keyword) == 0) {
        throw invalid_argument("Error: Kata kunci pencarian tidak boleh kosong!");
    }
    ...
    if(banyak > 0) {
        ...
        try {
            switch(kriteria) {
                ...
                default:
                    throw invalid_argument("Error: Pilihan tidak valid! Silakan pilih 1-4.");
            }
        }
        catch (const invalid_argument& e) {
            cout << "\nKESALAHAN DITEMUKAN " << e.what() << endl;
        }
            ...
            cout << "\nTerjadi kesalahan yang tidak diketahui!" << endl;
        }
    } else {
...
void tambahBinatang(Binatang kebunBinatang[], int *banyak) {
    if(*banyak < MAX_binatang) {
        ...
        try {
            ...
            cin >> b.jenis;
            validasiJenis(b.jenis);
            
            cout << "Masukkan habitat (Darat/Air/Udara): ";
            cin >> b.habitat;
            validasiHabitat(b.habitat);
            ...
            cout << "Data binatang GAGAL ditambahkan!" << endl;
        }
        catch (const runtime_error& e) {
            cout << "\nTERJADI KESALAHAN! " << e.what() << endl;
            cout << "Data binatang GAGAL ditambahkan!" << endl;
            ...
            cout << "\nTerjadi kesalahan yang tidak diketahui saat menambah data!" << endl;
        }
    } else {
        ...
        try {
            if(pilihan == 1) {
                ...
                if(index < 1 || index > banyak) {
                    throw out_of_range("Error: Nomor urut di luar batas array!");
                }
                ...
                if(kodeCari <= 0) {
                    throw invalid_argument("Error: Kode hewan harus positif!");
                }
                ...
                throw invalid_argument("Error: Pilihan tidak valid!");
            }
        }
        catch (const invalid_argument& e) {
            cout << "\nTERJADI KESALAHAN " << e.what() << endl;
        ...
        try {
            if(pilihan == 1) {
                ...
                if(nomor < 1 || nomor > banyak) {
                    throw out_of_range("Error: Nomor urut di luar batas!");
                }
                index = nomor - 1;
            }
            else if(pilihan == 2) {
            ...
            cout << "\nTERJADI KESALAHAN " << e.what() << endl;
            cout << "Data binatang GAGAL diubah!" << endl;
        }
        catch (const runtime_error& e) {
            cout << "\nTERJADI KESALAHAN " << e.what() << endl;
            cout << "Data binatang GAGAL diubah!" << endl;
    ...
    if(*banyak > 0) {
        ...
        try {
            if(pilihan == 1) {
                ...
                if(nomor < 1 || nomor > *banyak) {
                    throw out_of_range("[Peringatan] Nomor urut di luar batas!");
                }
                index = nomor - 1;
            }
            else if(pilihan == 2) {
                ...
                if(kodeCari <= 0) {
                    throw invalid_argument("[Peringatan] Kode hewan harus positif!");
                }
                ...
                throw invalid_argument("[Peringatan] Pilihan tidak valid!");
            }
            ...
            cout << "\n[Peringatan] Terjadi kesalahan saat menghapus data!" << endl;
        }
    } else {
